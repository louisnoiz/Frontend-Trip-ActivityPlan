...
<nav class="bg-white border-gray-200 dark:bg-blue-950 font-serif">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <a href="http://www.agoda.com/" class="flex items-center">
      <img src="https://cdn-icons-png.flaticon.com/512/2792/2792918.png" class="h-8 mr-3" alt="Flowbite Logo" />
      <span class="self-center text-2xl whitespace-nowrap dark:text-white">Trip-ActivityPlan</span>
  </a>
  <div class="flex md:order-2">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-blue-950 dark:border-gray-700">
        <li>
